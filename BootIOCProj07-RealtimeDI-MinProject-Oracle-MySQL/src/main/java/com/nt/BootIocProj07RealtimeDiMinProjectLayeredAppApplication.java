...
public class BootIocProj07RealtimeDiMinProjectLayeredAppApplication {

	public static void main(String[] args) {
		System.out.println("BootIocProj07RealtimeDiMinProjectLayeredAppApplication.main() (start)");
		//create  IOC container
		try(ConfigurableApplicationContext ctx=
				           SpringApplication.run(BootIocProj07RealtimeDiMinProjectLayeredAppApplication.class, args);
