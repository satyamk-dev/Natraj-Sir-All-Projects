...
public class BootIocProj08RealtimeDiMinProjectLayeredAppApplication {

	public static void main(String[] args) {
		//create  IOC container
		try(ConfigurableApplicationContext ctx=
				           SpringApplication.run(BootIocProj08RealtimeDiMinProjectLayeredAppApplication.class, args);
