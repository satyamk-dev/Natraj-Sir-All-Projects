...
public class HospitalOperationsController {
	...
	public   String    showReportByPagination(@PageableDefault(page=0,size=3,sort ="name",direction = Sort.Direction.ASC)    Pageable pageable,
			                                                                     Map<String,Object> map) {
		//use service
		Page<DoctorVO>  page=doctorService.showDoctorsByPagination(pageable);
